window.addEventListener('DOMContentLoaded', () => {
  ...
  fetch("./../../app/mypage/sidemenu.html")
    ...
    .then(data => {
      ...
      expertCourseMainMenu = document.querySelectorAll(`#li-expert-course-menu .a-mainsidemenu-title`);
      expertCourseSubMenuLi = document.querySelectorAll(`#li-expert-course-menu .li-subsidemenu`);
      expertCourseSubMenuA = document.querySelectorAll(`#li-expert-course-menu .li-subsidemenu a`);
...
let expertCourseMainMenu;
let expertCourseSubMenuA;
let expertCourseSubMenuLi;
